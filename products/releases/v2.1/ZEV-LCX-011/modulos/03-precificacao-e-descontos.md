...
- Precificar sem margem de contribuição.
- Projetar cenário único.
- Definir reserva por regra genérica.
...
### Desafio de domínio
Explique precificação e descontos para outra pessoa, aplique a um caso real, apresente evidência antes/depois e responda a três objeções sobre sua decisão sem recorrer a autoridade ou promessa.
