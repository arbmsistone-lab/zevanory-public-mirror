# ZEVANORY Vendas na Prática — Módulo 5

## Follow-up, pipeline e métricas
...
- Mover oportunidade sem critério.
- Responder objeção sem descobrir causa.
- Dar desconto sem medir margem.
...
### Desafio de domínio
Explique follow-up, pipeline e métricas para outra pessoa, aplique a um caso real, apresente evidência antes/depois e responda a três objeções sobre sua decisão sem recorrer a autoridade ou promessa.
