...
export default async function handler(req,res){
  ...
  try{
    ...
    return json(res,200,{provider:'tiktok',mode,connected:true,username:creator.username,nickname:creator.nickname,video_publish_authorized:true,tokens_stored_encrypted:true,identity_match:expected?true:null,commercial_enabled:false});
