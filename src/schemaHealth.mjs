export const REQUIRED_TABLES = Object.freeze([
  ...
  'customer_lifecycle_profiles','customer_lifecycle_events','attribution_touchpoints',
]);
...
export const REQUIRED_MIGRATIONS = Object.freeze([
  ...
  '010_payment_provider_abstraction','011_agent_control_and_trace','012_sales_lifecycle_v2',
]);
