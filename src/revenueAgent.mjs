...
export async function buildAgentContext(sql,job){
  ...
  return Object.freeze({job_type:job.job_type,lead,knowledge:knowledgeContext(knowledge),outcome_learning:outcomeLearning,commercial_engine_v2:commercialEngineV2,recent_conversation:Object.freeze(cleanRecent(recentRows)),lead_memory:Object.freeze(cleanMemory(memoryRows))});
}
