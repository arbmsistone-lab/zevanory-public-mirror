...
const whatsappLink=()=>`${OFFICIAL_WHATSAPP.url}?text=${encodeURIComponent('Olá! Tenho interesse nas soluções da ZEVANORY e gostaria de receber uma orientação personalizada.')}`;
