...
export const CHANNEL_PROFILES = Object.freeze({
  ...
  tiktok:Object.freeze({handle:'@zevanory3',profileUrl:'https://www.tiktok.com/@zevanory3',url:brandLink('tiktok'),bio:'Tecnologia, automacao, produtos digitais e bastidores reais da ZEVANORY.'}),
