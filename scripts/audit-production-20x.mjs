...
add('14 activation remains fail closed',config.body.commercial_enabled===false&&config.body.whatsapp_enabled===false&&agent.body.commercial_execution==='blocked'&&activation.body.commercial_enabled===false&&activation.body.activation_phase!=='live');
