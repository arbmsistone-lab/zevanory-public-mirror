...
add('08 release EG0038',release.r.status===200&&release.body.release_id==='ZEVANORY-EG0038-FINAL'&&assurance.r.status===200&&activation.r.status===200,release.body.release_id);
