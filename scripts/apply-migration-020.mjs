...
const raw=await readFile(new URL('../db/migrations/020_private_artifact_delivery.sql',import.meta.url),'utf8');
...
console.log(JSON.stringify({ok:true,migration:'020_private_artifact_delivery',schema:result}));
