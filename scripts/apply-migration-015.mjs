...
const raw=await readFile(new URL('../db/migrations/015_lifecycle_certification_provenance.sql',import.meta.url),'utf8');
...
console.log(JSON.stringify({ok:true,migration:'015_lifecycle_certification_provenance',schema:result}));