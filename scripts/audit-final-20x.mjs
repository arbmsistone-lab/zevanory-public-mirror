...
add('20 autonomous engine evals learning autonomy and provider confirmation 20x audits',run('scripts/audit-autonomous-engine-20x.mjs')&&run('scripts/audit-agent-evals-20x.mjs')&&run('scripts/audit-outcome-learning-20x.mjs')&&run('scripts/audit-autonomy-policy-20x.mjs')&&run('scripts/audit-provider-confirmation-20x.mjs'));
