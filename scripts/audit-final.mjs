...
add('03 required migrations',REQUIRED_MIGRATIONS.length===14&&REQUIRED_MIGRATIONS.includes('010_payment_provider_abstraction')&&REQUIRED_MIGRATIONS.includes('011_agent_control_and_trace')&&REQUIRED_MIGRATIONS.includes('012_sales_lifecycle_v2')&&REQUIRED_MIGRATIONS.includes('014_lifecycle_evidence_trust'));
