...
add('02 required schema tables',REQUIRED_TABLES.length===20&&['integration_outbox','agent_jobs','agent_runs','agent_memory','agent_control_state','agent_approvals','customer_lifecycle_profiles','customer_lifecycle_events','attribution_touchpoints'].every(x=>REQUIRED_TABLES.includes(x)));
add('03 required migrations',REQUIRED_MIGRATIONS.length===12&&REQUIRED_MIGRATIONS.includes('010_payment_provider_abstraction')&&REQUIRED_MIGRATIONS.includes('011_agent_control_and_trace')&&REQUIRED_MIGRATIONS.includes('012_sales_lifecycle_v2'));
