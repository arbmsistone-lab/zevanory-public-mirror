...
const raw=await readFile(new URL('../db/migrations/010_payment_provider_abstraction.sql',import.meta.url),'utf8');
...
console.log(JSON.stringify({ok:true,migration:'010_payment_provider_abstraction',schema:result}));