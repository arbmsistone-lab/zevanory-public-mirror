...
add('01 local equals GitHub main',head===origin,`${head}|${origin}`);
add('02 local equals GitLab main',head===gitlab,`${head}|${gitlab}`);
add('03 GitHub equals GitLab',origin!==''&&origin===gitlab,`${origin}|${gitlab}`);
