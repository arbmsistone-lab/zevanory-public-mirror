...
const raw=await readFile(new URL('../db/migrations/013_lifecycle_evidence_certification.sql',import.meta.url),'utf8');
...
console.log(JSON.stringify({ok:true,migration:'013_lifecycle_evidence_certification',schema:result}));
