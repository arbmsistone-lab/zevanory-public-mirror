...
const raw=await readFile(new URL('../db/migrations/006_sales_machine.sql', import.meta.url),'utf8');
...
console.log(JSON.stringify({ok:true,migration:'006_sales_machine',schema:result}));
