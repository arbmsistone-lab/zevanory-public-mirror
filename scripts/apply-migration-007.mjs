...
const raw=await readFile(new URL('../db/migrations/007_no_inventory_commerce.sql', import.meta.url),'utf8');
...
console.log(JSON.stringify({ok:true,migration:'007_no_inventory_commerce',schema:result}));