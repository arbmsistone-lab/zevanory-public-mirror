...
const raw=await readFile(new URL('../db/migrations/011_agent_control_and_trace.sql',import.meta.url),'utf8');
...
console.log(JSON.stringify({ok:true,migration:'011_agent_control_and_trace',schema:result}));
