...
const raw=await readFile(new URL('../db/migrations/017_mercadolivre_oauth.sql',import.meta.url),'utf8');
...
console.log(JSON.stringify({ok:true,migration:'017_mercadolivre_oauth',schema:result}));
