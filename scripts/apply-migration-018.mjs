...
const raw=await readFile(new URL('../db/migrations/018_tiktok_oauth.sql',import.meta.url),'utf8');
...
console.log(JSON.stringify({ok:true,migration:'018_tiktok_oauth',schema:result}));
