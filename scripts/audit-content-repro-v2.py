...
manifest=root/'products/releases/v2.0/build-manifest.json'
...
run=subprocess.run([sys.executable,str(root/'scripts/build-content-products-v2.py')],cwd=root,capture_output=True,text=True)
if run.returncode:
