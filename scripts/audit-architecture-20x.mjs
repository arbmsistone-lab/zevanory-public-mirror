...
add('13 schema is composable 23x16',(await text('src/schemaHealth.mjs')).includes("'integration_outbox'")&&(await text('src/schemaHealth.mjs')).includes("'016_certification_pilot'"));
