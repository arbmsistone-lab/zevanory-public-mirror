...
add('13 schema is composable 15x10',(await text('src/schemaHealth.mjs')).includes("'integration_outbox'")&&(await text('src/schemaHealth.mjs')).includes("'010_payment_provider_abstraction'"));
