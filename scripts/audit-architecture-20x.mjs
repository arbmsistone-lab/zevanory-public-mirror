...
add('13 schema is composable 20x12',(await text('src/schemaHealth.mjs')).includes("'integration_outbox'")&&(await text('src/schemaHealth.mjs')).includes("'012_sales_lifecycle_v2'"));
