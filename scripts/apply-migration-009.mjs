...
const raw=await readFile(new URL('../db/migrations/009_composable_infrastructure.sql',import.meta.url),'utf8');
...
console.log(JSON.stringify({ok:true,migration:'009_composable_infrastructure',schema:result}));
