...
const routes=['criativos','solucoes','arbm-sist','zevanory-one','ia-na-pratica','vendas-na-pratica','lucro-e-caixa','combo-ia-vendas','negocio-completo','piloto','termos','privacidade','exclusao-dados','reembolso','afiliados'];
