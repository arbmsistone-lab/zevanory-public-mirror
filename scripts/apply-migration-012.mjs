...
const raw=await readFile(new URL('../db/migrations/012_sales_lifecycle_v2.sql',import.meta.url),'utf8');
...
console.log(JSON.stringify({ok:true,migration:'012_sales_lifecycle_v2',schema:result}));
