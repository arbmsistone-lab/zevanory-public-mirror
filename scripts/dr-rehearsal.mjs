...
const files = [
  ...
  '010_payment_provider_abstraction.sql','011_agent_control_and_trace.sql','012_sales_lifecycle_v2.sql','013_lifecycle_evidence_certification.sql','014_lifecycle_evidence_trust.sql',
];
