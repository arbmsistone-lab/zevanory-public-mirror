...
const raw=await readFile(new URL('../db/migrations/014_lifecycle_evidence_trust.sql',import.meta.url),'utf8');
...
console.log(JSON.stringify({ok:true,migration:'014_lifecycle_evidence_trust',schema:result}));