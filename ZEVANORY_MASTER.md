...
Dominio zevanory.api.br: NAO associado ao projeto Vercel neste estado; tentativa de associacao retorna 403 domain_not_owned. Registro.br autenticado chegou somente a etapa de IDENTIFICACAO (CPF/CNPJ) e informa que o dominio escolhido segue Processo de Liberacao; nenhuma identificacao sensivel foi preenchida e nenhuma compra foi executada. O deployment tecnico *.vercel.app esta protegido por Vercel Authentication/SSO (302 para vercel.com/sso-api), portanto nao deve ser tratado como superficie publica anonima.
