...
export default async function handler(req, res) {
  ...
  if(view==='closure_status'){
    const gate=salesGate(),channels=await channelStatusWithOAuth(true),distribution=commercialDistributionReadiness(),brand=brandIdentityReadiness(),pilot=certificationPilotStatus();
