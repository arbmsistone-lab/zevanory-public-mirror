...
test('service activation requires production payment and real operator identity',()=>{
  const base={ACTIVE_OFFER_TYPE:'service',OFFER_SELECTION_APPROVED:'true',SUPPLIER_LEGAL_NAME:'Empresa X',SUPPLIER_TAX_ID:'00.000.000/0000-00',SUPPLIER_ADDRESS:'Endereco',SUPPORT_CHANNEL:'support@example.com',SERVICE_DELIVERY_MODE:'digital',ASAAS_API_KEY:'key',ASAAS_WEBHOOK_TOKEN:'token'};
