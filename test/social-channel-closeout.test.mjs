...
test('TikTok standby runtime rejects automated execution',async()=>{
...
test('TikTok standby remains excluded regardless of commercial gate',async()=>{
...
test('LinkedIn standby runtime rejects automated execution',async()=>{
