...
const env={BUFFER_API_KEY:'buf-key',BUFFER_TIKTOK_CHANNEL_ID:'tt-1',BUFFER_LINKEDIN_CHANNEL_ID:'li-1'};
...
test('Buffer alternate automation is fail closed and channel specific',()=>{
  ...
  assert.equal(alternateAutomationReadiness('youtube',env).supported,false);
});
