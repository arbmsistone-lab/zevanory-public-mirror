...
- Schema candidato Lifecycle v2: 22 tabelas e migrations 001-015; producao permanece no schema anterior ate promocao auditada.
...
3. Banco, URL oficial, schema 22x15 e commercial safety devem estar validos.
...
3. Confirmar schema 22x15 e kill-switches bloqueados.
...
6. `scripts/dr-rehearsal.mjs` reconstrui migrations 001-015 em schema isolado e exige `ROLLBACK`.
