...
- Schema corrente: 15 tabelas e migrations 001-010.
...
3. Banco, URL oficial, schema 15x10 e commercial safety devem estar validos.
...
3. Confirmar schema 15x10 e kill-switches bloqueados.
...
6. `scripts/dr-rehearsal.mjs` reconstrui migrations 001-010 em schema isolado e exige `ROLLBACK`.
