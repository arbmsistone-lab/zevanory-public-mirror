...
- Schema candidato Lifecycle v2: 21 tabelas e migrations 001-014; producao permanece no schema anterior ate promocao auditada.
...
3. Banco, URL oficial, schema 21x14 e commercial safety devem estar validos.
...
3. Confirmar schema 21x14 e kill-switches bloqueados.
...
6. `scripts/dr-rehearsal.mjs` reconstrui migrations 001-014 em schema isolado e exige `ROLLBACK`.
